    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit, explicabo facilis nobis dignissimos fugiat neque laudantium laborum rerum minima cum quae unde eaque facere nemo iste placeat eum totam possimus?
        </p>
